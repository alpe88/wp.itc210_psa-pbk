...
<!-- Content Begins Here -->
	...
	<?php
		$args = array(
			 'post_name__in'      => ['awards', 'scholarships', 'executive','chapter-representatives','activities','membership','archival-management',
	...
	<?php if ( $p->have_posts() ) : $post_counter = 0; while ( $p->have_posts() ) : $p->the_post(); ?>
		...
		<?php if($post_counter % 2 == 0){?>
			<div class="container">
				<div class="row">
					<div class="row-height">
							<div class="col-xs-8 col-height col-middle force-fluid-left">
								<div class="inside">
									<div class="content">
										<p class="text-center text-xl uppercase"><?=the_title();?></p>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="row-height">
							...
							<div class="col-xs-8 col-height col-middle force-fluid-right">
								<div class="inside">
									<div class="content">
										<p class="text-center text-xl uppercase"><?=the_title();?></p>
									</div>
