	...
	<body <?php body_class(''); ?> >
		<nav id="nav_wrap" class="navbar navbar-default custom-navbar" role="navigation">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
			<a href="<?php echo home_url(); ?>"><img class="margin-bottom-sm center-block img-responsive" src="<?php bloginfo('template_directory');?>/images/puget-sound-association-phi-beta-kappa-honor-society-logo.svg" alt="Puget Sound Association of The Phi Beta Kappa Honor Society - Logo." />
							</a>
			</div>
				</div>
					</div>
			<div class="container-fluid nopadding">
				<div class="row-fluid nopadding">
					...
					<div class="search-right hidden-sm hidden-md hidden-lg">
						<?php get_search_form();?>
					</div>
					<div class="navbar-collapse collapse navbar-main brand-primary">
