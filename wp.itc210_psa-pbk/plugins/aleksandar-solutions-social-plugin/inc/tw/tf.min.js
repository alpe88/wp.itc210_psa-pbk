...
(d+='<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to='+n[b]+'" class="twitter_reply_icon"'+(q?' target="_blank">':">")+'<span class="glyphicon glyphicon-share-alt"></span></a>&nbsp&nbsp&nbsp<a href="https://twitter.com/intent/retweet?tweet_id='+n[b]+'" class="twitter_retweet_icon"'+(q?' target="_blank">':">")+'<span class="glyphicon glyphicon-retweet"></span></a>&nbsp&nbsp&nbsp<a href="https://twitter.com/intent/favorite?tweet_id='+n[b]+'" class="twitter_fav_icon"'+(q?' target="_blank">':">")+'<span class="glyphicon glyphicon-star"></span>'+"</a></p>");D&&void 0!==h[b]&&(l=h[b],void 0!==l?(l=l.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0],
...
function handleTweets(tweets){
    var x = tweets.length;
    var n = 0;
    var element = document.getElementById('tw-widget');
    var html = '<h4>Follow us on Twitter:</h4>' +
		'<ul>';
    while(n < x) {
      html += '<li>' + tweets[n] + '</li>';
      n++;
